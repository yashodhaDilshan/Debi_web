<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Register.aspx.cs" Inherits="Debi_web.Register" %>
        ...
        <div>
             ...
             <div class="Login">
                ...
                <div class="Form">                    
                    ...
                    <br />
                    <br />
                    <asp:Label CssClass="Login_lable" ID="Label1" runat="server" Text="Registration Form"></asp:Label>
                    <br />
                    <br/>
                    <br />
                       
                        <asp:TextBox CssClass="textbox" ID="txtuserName" runat="server" placeholder="User Name" MaxLength="5"></asp:TextBox>
                        <asp:TextBox CssClass="textbox" ID="txtEmail" runat="server" placeholder="Email" TextMode="Email"></asp:TextBox><br />                                             
                        ...
                        <a class="cancel" href="#">Cancel</a><br />

                        <asp:Label CssClass="message" ID="lblresult" runat="server" Text=""></asp:Label>
